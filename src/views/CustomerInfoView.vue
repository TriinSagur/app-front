<template>
  ...
  <div>
    <button v-on:click="hideTableDiv" type="button" className="btn btn-outline-danger">Peida</button>
    <button v-on:click="displayTableDiv" type="button" className="btn btn-outline-success m-3">Näita</button>
    <br>
    <br>
    ...
    <div v-if="tableDivDisplay">
      ...
      <table className="table table-hover">
        ...
        <tr v-for="customer in customers">
          ...
          <td>
            <button type="button" className="btn btn-outline-dark" v-on:click="navigateToAccountsInfo(customer.id)">
              Dark
            </button>
          </td>
        </tr>
