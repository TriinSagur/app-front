<template>
  ...
  <div>
    ...
    <div>
      ...
      <button v-on:click="saveDataToSessionStorage" type="button" class="btn btn-danger">Session storage</button>

      <button v-on:click="saveDataToLocalStorage" type="button" class="btn btn-success m-5">Local storage</button>
      <br>
      <br>
