<template>
  <div>
    ...
    <button v-on:click="saveDataToSessionStorage" type="button" class="btn btn-success">Session storage</button>
    <button v-on:click="saveDataToLocalStorage"  type="button" class="btn btn-danger">Local storage</button>
  </div>
</template>
