<template>
  ...
  <div>
    ...
    <div>
      ...
      <br>
      <br>
      <button v-on:click="saveDataToSessionStorage" type="button" class="btn btn-outline-success m-3">Session storage</button>
      <button v-on:click="saveDataToLocalStorage" type="button" class="btn btn-outline-danger">Local storage</button>
