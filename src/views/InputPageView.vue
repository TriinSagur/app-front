<template>
  <div>
    ...
    <div>
      ...
      <br>
      <br>
      <button v-on:click="saveDataToSessionStorage" type="button" class="btn btn-outline-danger">Session storage</button>
      <button v-on:click="saveDataToLocalStorage" type="button" class="btn btn-outline-success m-3">Local storage</button>
    </div>
...
export default {
  ...
  methods: {
    saveDataToSessionStorage: function () {
      ...
      sessionStorage.setItem('isikukood', this.customer.isikukood)
    ...
    saveDataToLocalStorage: function () {
      ...
      localStorage.setItem('isikukood', this.customer.isikukood)
